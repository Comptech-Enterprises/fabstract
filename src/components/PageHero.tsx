...
export function PageHero({
  ...
  return (
    <section className="relative min-h-[78vh] flex items-end">
      ...
      <div className="pointer-events-none absolute inset-0 z-[1] bg-gradient-to-r from-stone/60 via-stone/25 to-transparent" />
      <div className="pointer-events-none absolute inset-0 z-[1] bg-gradient-to-t from-stone/50 via-transparent to-stone/20" />
      <div className="relative z-10 px-6 sm:px-10 lg:px-14 pt-32 pb-8 max-w-4xl">
        <motion.p
