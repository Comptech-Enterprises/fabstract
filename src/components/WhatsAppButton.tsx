  ...
  return (
    <>
      ...
      {open && (
        ...
        >
          ...
          <div className="px-4 py-3 flex items-center gap-3 bg-teal">
            <div className="w-9 h-9 bg-teal flex items-center justify-center flex-shrink-0 border border-white/20">
      ...
      <button
        ...
        className="fixed bottom-6 right-4 sm:right-6 z-50 w-14 h-14 shadow-lg bg-crimson hover:bg-[#243344] transition-colors flex items-center justify-center"
      >
        {open ? (
