          ...
          <div className="py-24 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <div className="bg-floral-white rounded-2xl p-8 border border-bone/50">
                ...
                <h3 className="text-smoky-black font-bold text-lg mb-3">Our Mission</h3>
              ...
              <div className="bg-floral-white rounded-2xl p-8 border border-bone/50">
                ...
                <h3 className="text-smoky-black font-bold text-lg mb-3">Our Vision</h3>
                <p className="text-smoky-black/65 leading-relaxed">
              ...
              <div className="bg-floral-white rounded-2xl p-8 border border-bone/50">
                ...
                <h3 className="text-smoky-black font-bold text-lg mb-3">Our Values</h3>
