    ...
    <>
      ...
      <main className="bg-cream">
        ...
        <section className="mx-auto max-w-6xl px-5 sm:px-8 py-14 sm:py-20">
          <SectionReveal className="grid lg:grid-cols-12 gap-8 lg:gap-16 items-start">
            ...
            <div className="mx-auto max-w-6xl px-5 sm:px-8 py-14 sm:py-20">
              <SectionReveal className="grid lg:grid-cols-12 gap-8 lg:gap-14 items-center">
                ...
                <div className="lg:col-span-6">
                  ...
                  <h2 className="mt-2 font-display font-semibold text-3xl sm:text-5xl text-ink tracking-tight">
                    {chapter.title}
                  </h2>
        ...
        <section id="marks" className="scroll-mt-24 border-t border-sand">
          <div className="mx-auto max-w-6xl px-5 sm:px-8 py-14 sm:py-20">
